...
class ReberGenerator:
    ...
    def __init__(self, max_length: int = 25, num_perturbations: int = 1):
        """
        :param max_length: the maximum length of any string, valid reber or otherwise, generated by this `self.make_data`
        :param num_perturbations: the number of perturbations made in strings in `self.make_perturbed_embedded_reber_string`
        """
